...
class UnsetHomeCommand extends FactionsCommand{

    public function __construct(){
        parent::__construct(["unsethome"], "Unset your faction's home", "Use: '/f unsethome'");
    }
    ...
    public function execute(CommandSender $sender, array $args, FactionsPM $plugin) : void{
        ...
        $plugin->getDatabase()->updateFactionHome($faction->getId(), null);
        $faction->setHome(null);
        $faction->broadcastMessage(TextFormat::GREEN . $sender->getName() . " has unset your faction's home");
    }
}