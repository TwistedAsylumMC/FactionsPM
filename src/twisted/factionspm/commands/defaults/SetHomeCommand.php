...
class SetHomeCommand extends FactionsCommand{

    public function __construct(){
        parent::__construct(["sethome"], "Set your faction's home", "Use: '/f sethome'");
    }
    ...
    public function execute(CommandSender $sender, array $args, FactionsPM $plugin) : void{
        ...
        $home = $sender->asPosition();
        $plugin->getDatabase()->updateFactionHome($faction->getId(), $home);
        $faction->setHome($home);
        $faction->broadcastMessage(TextFormat::GREEN . $sender->getName() . " has updated your faction's home");
    }
}